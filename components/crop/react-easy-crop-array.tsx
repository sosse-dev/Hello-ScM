...
const ImageCropDialogArray = ({
  ...
  return (
    <div className="fixed top-0 left-0 mx-auto m-auto w-full bg-white h-[40rem] flex flex-col items-center justify-center">
      {/* <div className="bg-white backdrop"></div> */}
      <div className="w-full h-[10rem]">
        <Cropper
          image={imageUrl?.[imageUrl.length]}
          zoom={zoom}
          crop={crop}
          aspect={1 / 1}
          cropShape="round"
      ...
      <div className="fixed bottom-0 left-0 w-full h-[5rem] bg-slate-800 pt-2 gap-y-1 flex flex-col items-center">
        ...
        <div className="mr-8">
          ...
          <Button
            onClick={() =>
              onCrop(imageUrl?.[imageUrl.length], croppedAreaPixels)
            }
          >
            Crop
          </Button>
...
export default ImageCropDialogArray;
